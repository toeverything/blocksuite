[API](../../../index.md) > [@blocksuite/lit](../index.md) > WidgetElement

# Class: WidgetElement`<B>`

## Extends

- `LitElement`\< `this` \> & [`DisposableClass`](class.DisposableClass.md)\< `this` \>

## Other

### constructor

> **new WidgetElement**<`B`>(): [`WidgetElement`](class.WidgetElement.md)\< `B` \>

#### Type parameters

| Parameter | Default |
| :------ | :------ |
| `B` *extends* [`BlockElement`](class.BlockElement.md)\< [`BaseBlockModel`](../../store/classes/class.BaseBlockModel.md)\< `object` \>, [`BlockService`](../../block-std/classes/class.BlockService.md)\< [`BaseBlockModel`](../../store/classes/class.BaseBlockModel.md)\< `object` \> \>, `string` \> | [`BlockElement`](class.BlockElement.md)\< [`BaseBlockModel`](../../store/classes/class.BaseBlockModel.md)\< `object` \>, [`BlockService`](../../block-std/classes/class.BlockService.md)\< [`BaseBlockModel`](../../store/classes/class.BaseBlockModel.md)\< `object` \> \>, `string` \> |

#### Returns

[`WidgetElement`](class.WidgetElement.md)\< `B` \>
...
WithDisposable(LitElement).ATTRIBUTE\_NODE
...
WithDisposable(LitElement).CDATA\_SECTION\_NODE
...
WithDisposable(LitElement).COMMENT\_NODE
...
WithDisposable(LitElement).DOCUMENT\_FRAGMENT\_NODE
...
WithDisposable(LitElement).DOCUMENT\_NODE
...
WithDisposable(LitElement).DOCUMENT\_POSITION\_CONTAINED\_BY
...
WithDisposable(LitElement).DOCUMENT\_POSITION\_CONTAINS
...
WithDisposable(LitElement).DOCUMENT\_POSITION\_DISCONNECTED
...
WithDisposable(LitElement).DOCUMENT\_POSITION\_FOLLOWING
...
WithDisposable(LitElement).DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC
...
WithDisposable(LitElement).DOCUMENT\_POSITION\_PRECEDING
...
WithDisposable(LitElement).DOCUMENT\_TYPE\_NODE
...
WithDisposable(LitElement).ELEMENT\_NODE
...
WithDisposable(LitElement).ENTITY\_NODE
...
WithDisposable(LitElement).ENTITY\_REFERENCE\_NODE
...
WithDisposable(LitElement).NOTATION\_NODE
...
WithDisposable(LitElement).PROCESSING\_INSTRUCTION\_NODE
...
WithDisposable(LitElement).TEXT\_NODE
...
WithDisposable(LitElement).accessKey
...
WithDisposable(LitElement).accessKeyLabel
...
WithDisposable(LitElement).ariaAtomic
...
WithDisposable(LitElement).ariaAutoComplete
...
WithDisposable(LitElement).ariaBusy
...
WithDisposable(LitElement).ariaChecked
...
WithDisposable(LitElement).ariaColCount
...
WithDisposable(LitElement).ariaColIndex
...
WithDisposable(LitElement).ariaColSpan
...
WithDisposable(LitElement).ariaCurrent
...
WithDisposable(LitElement).ariaDisabled
...
WithDisposable(LitElement).ariaExpanded
...
WithDisposable(LitElement).ariaHasPopup
...
WithDisposable(LitElement).ariaHidden
...
WithDisposable(LitElement).ariaInvalid
...
WithDisposable(LitElement).ariaKeyShortcuts
...
WithDisposable(LitElement).ariaLabel
...
WithDisposable(LitElement).ariaLevel
...
WithDisposable(LitElement).ariaLive
...
WithDisposable(LitElement).ariaModal
...
WithDisposable(LitElement).ariaMultiLine
...
WithDisposable(LitElement).ariaMultiSelectable
...
WithDisposable(LitElement).ariaOrientation
...
WithDisposable(LitElement).ariaPlaceholder
...
WithDisposable(LitElement).ariaPosInSet
...
WithDisposable(LitElement).ariaPressed
...
WithDisposable(LitElement).ariaReadOnly
...
WithDisposable(LitElement).ariaRequired
...
WithDisposable(LitElement).ariaRoleDescription
...
WithDisposable(LitElement).ariaRowCount
...
WithDisposable(LitElement).ariaRowIndex
...
WithDisposable(LitElement).ariaRowSpan
...
WithDisposable(LitElement).ariaSelected
...
WithDisposable(LitElement).ariaSetSize
...
WithDisposable(LitElement).ariaSort
...
WithDisposable(LitElement).ariaValueMax
...
WithDisposable(LitElement).ariaValueMin
...
WithDisposable(LitElement).ariaValueNow
...
WithDisposable(LitElement).ariaValueText
...
WithDisposable(LitElement).assignedSlot
...
WithDisposable(LitElement).attributeStyleMap
...
WithDisposable(LitElement).attributes
...
WithDisposable(LitElement).autocapitalize
...
WithDisposable(LitElement).autofocus
...
WithDisposable(LitElement).baseURI
...
WithDisposable(LitElement).childElementCount
...
WithDisposable(LitElement).childNodes
...
WithDisposable(LitElement).children
...
WithDisposable(LitElement).classList
...
WithDisposable(LitElement).className
...
WithDisposable(LitElement).clientHeight
...
WithDisposable(LitElement).clientLeft
...
WithDisposable(LitElement).clientTop
...
WithDisposable(LitElement).clientWidth
...
WithDisposable(LitElement).contentEditable
...
WithDisposable(LitElement).dataset
...
WithDisposable(LitElement).draggable
...
WithDisposable(LitElement).enterKeyHint
...
WithDisposable(LitElement).firstChild
...
WithDisposable(LitElement).firstElementChild
...
WithDisposable(LitElement).hidden
...
WithDisposable(LitElement).inert
...
WithDisposable(LitElement).innerHTML
...
WithDisposable(LitElement).innerText
...
WithDisposable(LitElement).inputMode
...
WithDisposable(LitElement).isConnected
...
WithDisposable(LitElement).isContentEditable
...
WithDisposable(LitElement).lang
...
WithDisposable(LitElement).lastChild
...
WithDisposable(LitElement).lastElementChild
...
WithDisposable(LitElement).localName
...
WithDisposable(LitElement).namespaceURI
...
WithDisposable(LitElement).nextElementSibling
...
WithDisposable(LitElement).nextSibling
...
WithDisposable(LitElement).nodeName
...
WithDisposable(LitElement).nodeType
...
WithDisposable(LitElement).nodeValue
...
WithDisposable(LitElement).nonce
...
WithDisposable(LitElement).offsetHeight
...
WithDisposable(LitElement).offsetLeft
...
WithDisposable(LitElement).offsetParent
...
WithDisposable(LitElement).offsetTop
...
WithDisposable(LitElement).offsetWidth
...
WithDisposable(LitElement).onabort
...
WithDisposable(LitElement).onanimationcancel
...
WithDisposable(LitElement).onanimationend
...
WithDisposable(LitElement).onanimationiteration
...
WithDisposable(LitElement).onanimationstart
...
WithDisposable(LitElement).onauxclick
...
WithDisposable(LitElement).onbeforeinput
...
WithDisposable(LitElement).onblur
...
WithDisposable(LitElement).oncancel
...
WithDisposable(LitElement).oncanplay
...
WithDisposable(LitElement).oncanplaythrough
...
WithDisposable(LitElement).onchange
...
WithDisposable(LitElement).onclick
...
WithDisposable(LitElement).onclose
...
WithDisposable(LitElement).oncontextmenu
...
WithDisposable(LitElement).oncopy
...
WithDisposable(LitElement).oncuechange
...
WithDisposable(LitElement).oncut
...
WithDisposable(LitElement).ondblclick
...
WithDisposable(LitElement).ondrag
...
WithDisposable(LitElement).ondragend
...
WithDisposable(LitElement).ondragenter
...
WithDisposable(LitElement).ondragleave
...
WithDisposable(LitElement).ondragover
...
WithDisposable(LitElement).ondragstart
...
WithDisposable(LitElement).ondrop
...
WithDisposable(LitElement).ondurationchange
...
WithDisposable(LitElement).onemptied
...
WithDisposable(LitElement).onended
...
WithDisposable(LitElement).onerror
...
WithDisposable(LitElement).onfocus
...
WithDisposable(LitElement).onformdata
...
WithDisposable(LitElement).onfullscreenchange
...
WithDisposable(LitElement).onfullscreenerror
...
WithDisposable(LitElement).ongotpointercapture
...
WithDisposable(LitElement).oninput
...
WithDisposable(LitElement).oninvalid
...
WithDisposable(LitElement).onkeydown
...
WithDisposable(LitElement).onkeypress
...
WithDisposable(LitElement).onkeyup
...
WithDisposable(LitElement).onload
...
WithDisposable(LitElement).onloadeddata
...
WithDisposable(LitElement).onloadedmetadata
...
WithDisposable(LitElement).onloadstart
...
WithDisposable(LitElement).onlostpointercapture
...
WithDisposable(LitElement).onmousedown
...
WithDisposable(LitElement).onmouseenter
...
WithDisposable(LitElement).onmouseleave
...
WithDisposable(LitElement).onmousemove
...
WithDisposable(LitElement).onmouseout
...
WithDisposable(LitElement).onmouseover
...
WithDisposable(LitElement).onmouseup
...
WithDisposable(LitElement).onpaste
...
WithDisposable(LitElement).onpause
...
WithDisposable(LitElement).onplay
...
WithDisposable(LitElement).onplaying
...
WithDisposable(LitElement).onpointercancel
...
WithDisposable(LitElement).onpointerdown
...
WithDisposable(LitElement).onpointerenter
...
WithDisposable(LitElement).onpointerleave
...
WithDisposable(LitElement).onpointermove
...
WithDisposable(LitElement).onpointerout
...
WithDisposable(LitElement).onpointerover
...
WithDisposable(LitElement).onpointerup
...
WithDisposable(LitElement).onprogress
...
WithDisposable(LitElement).onratechange
...
WithDisposable(LitElement).onreset
...
WithDisposable(LitElement).onresize
...
WithDisposable(LitElement).onscroll
...
WithDisposable(LitElement).onscrollend
...
WithDisposable(LitElement).onsecuritypolicyviolation
...
WithDisposable(LitElement).onseeked
...
WithDisposable(LitElement).onseeking
...
WithDisposable(LitElement).onselect
...
WithDisposable(LitElement).onselectionchange
...
WithDisposable(LitElement).onselectstart
...
WithDisposable(LitElement).onslotchange
...
WithDisposable(LitElement).onstalled
...
WithDisposable(LitElement).onsubmit
...
WithDisposable(LitElement).onsuspend
...
WithDisposable(LitElement).ontimeupdate
...
WithDisposable(LitElement).ontoggle
...
WithDisposable(LitElement).ontouchcancel
...
WithDisposable(LitElement).ontouchend
...
WithDisposable(LitElement).ontouchmove
...
WithDisposable(LitElement).ontouchstart
...
WithDisposable(LitElement).ontransitioncancel
...
WithDisposable(LitElement).ontransitionend
...
WithDisposable(LitElement).ontransitionrun
...
WithDisposable(LitElement).ontransitionstart
...
WithDisposable(LitElement).onvolumechange
...
WithDisposable(LitElement).onwaiting
...
WithDisposable(LitElement).onwebkitanimationend
...
WithDisposable(LitElement).onwebkitanimationiteration
...
WithDisposable(LitElement).onwebkitanimationstart
...
WithDisposable(LitElement).onwebkittransitionend
...
WithDisposable(LitElement).onwheel
...
WithDisposable(LitElement).outerHTML
...
WithDisposable(LitElement).outerText
...
WithDisposable(LitElement).ownerDocument
...
[packages/lit/src/element/widget-element.ts:19](https://github.com/Saul-Mirone/blocksuite/blob/f2324b82e/packages/lit/src/element/widget-element.ts#L19)
...
WithDisposable(LitElement).parentElement
...
WithDisposable(LitElement).parentNode
...
WithDisposable(LitElement).part
...
[packages/lit/src/element/widget-element.ts:21](https://github.com/Saul-Mirone/blocksuite/blob/f2324b82e/packages/lit/src/element/widget-element.ts#L21)
...
WithDisposable(LitElement).popover
...
WithDisposable(LitElement).prefix
...
WithDisposable(LitElement).previousElementSibling
...
WithDisposable(LitElement).previousSibling
...
WithDisposable(LitElement).role
...
[packages/lit/src/element/widget-element.ts:16](https://github.com/Saul-Mirone/blocksuite/blob/f2324b82e/packages/lit/src/element/widget-element.ts#L16)
...
WithDisposable(LitElement).scrollHeight
...
WithDisposable(LitElement).scrollLeft
...
WithDisposable(LitElement).scrollTop
...
WithDisposable(LitElement).scrollWidth
...
WithDisposable(LitElement).shadowRoot
...
WithDisposable(LitElement).slot
...
WithDisposable(LitElement).spellcheck
...
WithDisposable(LitElement).style
...
WithDisposable(LitElement).tabIndex
...
WithDisposable(LitElement).tagName
...
WithDisposable(LitElement).textContent
...
WithDisposable(LitElement).title
...
WithDisposable(LitElement).translate
...
WithDisposable(LitElement).[metadata]
...
WithDisposable(LitElement).\_$litElement$
...
WithDisposable(LitElement).\_initializers
...
WithDisposable(LitElement).finalized
...
[packages/lit/src/element/widget-element.ts:31](https://github.com/Saul-Mirone/blocksuite/blob/f2324b82e/packages/lit/src/element/widget-element.ts#L31)
...
[packages/lit/src/element/widget-element.ts:39](https://github.com/Saul-Mirone/blocksuite/blob/f2324b82e/packages/lit/src/element/widget-element.ts#L39)
...
[packages/lit/src/element/widget-element.ts:27](https://github.com/Saul-Mirone/blocksuite/blob/f2324b82e/packages/lit/src/element/widget-element.ts#L27)
...
[packages/lit/src/element/widget-element.ts:44](https://github.com/Saul-Mirone/blocksuite/blob/f2324b82e/packages/lit/src/element/widget-element.ts#L44)
...
[packages/lit/src/element/widget-element.ts:23](https://github.com/Saul-Mirone/blocksuite/blob/f2324b82e/packages/lit/src/element/widget-element.ts#L23)
...
WithDisposable(LitElement).addEventListener
...
WithDisposable(LitElement).after
...
WithDisposable(LitElement).animate
...
WithDisposable(LitElement).append
...
WithDisposable(LitElement).appendChild
...
WithDisposable(LitElement).attachInternals
...
WithDisposable(LitElement).attachShadow
...
WithDisposable(LitElement).before
...
[packages/lit/src/element/widget-element.ts:60](https://github.com/Saul-Mirone/blocksuite/blob/f2324b82e/packages/lit/src/element/widget-element.ts#L60)
...
WithDisposable(LitElement).blur
...
WithDisposable(LitElement).checkVisibility
...
WithDisposable(LitElement).click
...
WithDisposable(LitElement).cloneNode
...
WithDisposable(LitElement).closest
...
WithDisposable(LitElement).compareDocumentPosition
...
WithDisposable(LitElement).computedStyleMap
...
[packages/lit/src/element/widget-element.ts:71](https://github.com/Saul-Mirone/blocksuite/blob/f2324b82e/packages/lit/src/element/widget-element.ts#L71)
...
WithDisposable(LitElement).contains
...
WithDisposable(LitElement).dispatchEvent
...
WithDisposable(LitElement).focus
...
WithDisposable(LitElement).getAnimations
...
WithDisposable(LitElement).getAttribute
...
WithDisposable(LitElement).getAttributeNS
...
WithDisposable(LitElement).getAttributeNames
...
WithDisposable(LitElement).getAttributeNode
...
WithDisposable(LitElement).getAttributeNodeNS
...
WithDisposable(LitElement).getBoundingClientRect
...
WithDisposable(LitElement).getClientRects
...
WithDisposable(LitElement).getElementsByClassName
...
WithDisposable(LitElement).getElementsByTagName
...
WithDisposable(LitElement).getElementsByTagNameNS
...
WithDisposable(LitElement).getRootNode
...
| `handler` | [`UIEventHandler`](../../block-std/type-aliases/type-alias.UIEventHandler.md) |
| `options`? | `object` |
| `options.global`? | `boolean` |
...
[packages/lit/src/element/widget-element.ts:48](https://github.com/Saul-Mirone/blocksuite/blob/f2324b82e/packages/lit/src/element/widget-element.ts#L48)
...
WithDisposable(LitElement).hasAttribute
...
WithDisposable(LitElement).hasAttributeNS
...
WithDisposable(LitElement).hasAttributes
...
WithDisposable(LitElement).hasChildNodes
...
WithDisposable(LitElement).hasPointerCapture
...
WithDisposable(LitElement).hidePopover
...
WithDisposable(LitElement).insertAdjacentElement
...
WithDisposable(LitElement).insertAdjacentHTML
...
WithDisposable(LitElement).insertAdjacentText
...
WithDisposable(LitElement).insertBefore
...
WithDisposable(LitElement).isDefaultNamespace

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16178
...
WithDisposable(LitElement).isEqualNode

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16184
...
WithDisposable(LitElement).isSameNode

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16186
...
WithDisposable(LitElement).lookupNamespaceURI

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16188
...
WithDisposable(LitElement).lookupPrefix

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16190
...
WithDisposable(LitElement).matches

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7771
...
WithDisposable(LitElement).normalize

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16196
...
WithDisposable(LitElement).prepend

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16795
...
WithDisposable(LitElement).querySelector

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16801
...
node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16802
...
node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16803
...
node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16805
...
node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16806
...
WithDisposable(LitElement).querySelectorAll

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16812
...
node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16813
...
node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16814
...
node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16816
...
node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16817
...
WithDisposable(LitElement).releasePointerCapture

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7773
...
WithDisposable(LitElement).remove

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:5611
...
WithDisposable(LitElement).removeAttribute

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7779
...
WithDisposable(LitElement).removeAttributeNS

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7785
...
WithDisposable(LitElement).removeAttributeNode

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7787
...
WithDisposable(LitElement).removeChild

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16198
...
WithDisposable(LitElement).removeEventListener

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:10098
...
node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:10099
...
[packages/lit/src/element/widget-element.ts:76](https://github.com/Saul-Mirone/blocksuite/blob/f2324b82e/packages/lit/src/element/widget-element.ts#L76)
...
WithDisposable(LitElement).replaceChild

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16200
...
WithDisposable(LitElement).replaceChildren

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:16825
...
WithDisposable(LitElement).replaceWith

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:5619
...
WithDisposable(LitElement).requestFullscreen

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7795
...
WithDisposable(LitElement).requestPointerLock

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7797
...
WithDisposable(LitElement).scroll

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7799
...
node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7800
...
WithDisposable(LitElement).scrollBy

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7802
...
node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7803
...
WithDisposable(LitElement).scrollIntoView

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7805
...
WithDisposable(LitElement).scrollTo

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7807
...
node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7808
...
WithDisposable(LitElement).setAttribute

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7814
...
WithDisposable(LitElement).setAttributeNS

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7820
...
WithDisposable(LitElement).setAttributeNode

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7822
...
WithDisposable(LitElement).setAttributeNodeNS

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7824
...
WithDisposable(LitElement).setPointerCapture

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7826
...
WithDisposable(LitElement).showPopover

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:10093
...
WithDisposable(LitElement).toggleAttribute

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7834
...
WithDisposable(LitElement).togglePopover

#### Defined In

node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:10095
...
WithDisposable(LitElement).webkitMatchesSelector
...
node\_modules/.pnpm/typescript@5.2.2/node\_modules/typescript/lib/lib.dom.d.ts:7840
...
WithDisposable(LitElement).addInitializer

#### Nocollapse

#### Defined In

node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:257
...
WithDisposable(LitElement).finalize

#### Nocollapse

#### Defined In

node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:441
...
node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:346

#### Inherited from

WithDisposable(LitElement).observedAttributes
...
WithDisposable(LitElement).attributeChangedCallback

#### Defined In

node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:580
...
WithDisposable(LitElement).addController

#### Defined In

node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:519
...
WithDisposable(LitElement).removeController

#### Defined In

node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:524

## dev-mode

### disableWarning

> `static` `optional` **disableWarning**: `function`
...
node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:223

#### Inherited from

WithDisposable(LitElement).disableWarning

***

### enableWarning

> `static` `optional` **enableWarning**: `function`
...
node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:205

#### Inherited from

WithDisposable(LitElement).enableWarning
...
node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:187

#### Inherited from

WithDisposable(LitElement).enabledWarnings
...
WithDisposable(LitElement).disconnectedCallback

#### Defined In

node\_modules/.pnpm/lit-element@4.0.2/node\_modules/lit-element/development/lit-element.d.ts:142
...
node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:280

#### Inherited from

WithDisposable(LitElement).elementProperties
...
node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:306

#### Inherited from

WithDisposable(LitElement).properties
...
WithDisposable(LitElement).createProperty

#### Nocollapse

#### Defined In

node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:373
...
WithDisposable(LitElement).getPropertyDescriptor

#### Nocollapse

#### Defined In

node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:401
...
[`createProperty`](class.WidgetElement.md#createproperty).
...
WithDisposable(LitElement).getPropertyOptions
...
node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:416
...
node\_modules/.pnpm/lit-element@4.0.2/node\_modules/lit-element/development/lit-element.d.ts:88

#### Inherited from

WithDisposable(LitElement).renderOptions
...
node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:473

#### Inherited from

WithDisposable(LitElement).renderRoot
...
node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:452

#### Inherited from

WithDisposable(LitElement).shadowRootOptions
...
WithDisposable(LitElement).createRenderRoot

#### Defined In

node\_modules/.pnpm/lit-element@4.0.2/node\_modules/lit-element/development/lit-element.d.ts:93
...
node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:313

#### Inherited from

WithDisposable(LitElement).elementStyles
...
node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:340
...
WithDisposable(LitElement).finalizeStyles

#### Nocollapse

#### Defined In

node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:467
...
node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:491

#### Inherited from

WithDisposable(LitElement).hasUpdated
...
node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:485

#### Inherited from

WithDisposable(LitElement).isUpdatePending
...
node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:671

#### Inherited from

WithDisposable(LitElement).updateComplete
...
WithDisposable(LitElement).enableUpdating

#### Defined In

node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:560
...
node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:742
...
WithDisposable(LitElement).getUpdateComplete

#### Defined In

node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:695
...
WithDisposable(LitElement).performUpdate

#### Defined In

node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:631
...
| `options`? | `PropertyDeclaration`\< `unknown`, `unknown` \> | property options to use instead of the previously<br />    configured options |
...
WithDisposable(LitElement).requestUpdate

#### Defined In

node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:598
...
WithDisposable(LitElement).scheduleUpdate

#### Defined In

node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:620
...
WithDisposable(LitElement).shouldUpdate

#### Defined In

node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:704
...
WithDisposable(LitElement).update

#### Defined In

node\_modules/.pnpm/lit-element@4.0.2/node\_modules/lit-element/development/lit-element.d.ts:101
...
node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:725
...
WithDisposable(LitElement).willUpdate

#### Defined In

node\_modules/.pnpm/@lit+reactive-element@2.0.2/node\_modules/@lit/reactive-element/development/reactive-element.d.ts:653
