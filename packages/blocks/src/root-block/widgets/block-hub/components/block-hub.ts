...
export class BlockHub extends WithDisposable(ShadowlessElement) {
  ...
  private _lastDraggingFlavour: null | string = null;
  ...
  private accessor _blockHubCards!: HTMLElement[] & NodeList;
  ...
  private accessor _blockHubMenus!: HTMLElement[] & NodeList;
