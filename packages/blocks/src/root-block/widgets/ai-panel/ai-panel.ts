...
export class AffineAIPanelWidget extends WidgetElement {
  ...
  private _answer: null | string = null;
  ...
  private _inputText: null | string = null;
  ...
  private _stopAutoUpdate?: (() => void) | undefined;
  ...
  generate = () => {
    ...
    const finish = (type: 'aborted' | 'error' | 'success', err?: AIError) => {
