...
export type ShapeName = 'roundedRect' | ShapeType;
...
export class EdgelessShapeToolElement extends WithDisposable(LitElement) {
  ...
  private _transformMap: TransformMap = {
    hidden: { origin: '50% 50%', scale: 0, x: 0, y: 120 },
    z1: { origin: '50% 100%', scale: 1.1, x: 0, y: 5 },
    z2: { origin: '20% 20%', scale: 0.75, x: -15, y: 0 },
    z3: { origin: '80% 20%', scale: 0.75, x: 15, y: 0 },
  };
