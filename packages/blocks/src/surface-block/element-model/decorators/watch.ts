...
type WatchFn<T extends SurfaceNode = SurfaceNode> = (
  oldValue: unknown,
  instance: T,
  local: boolean
) => void;
 ...
 */
export function watch<V, T extends SurfaceNode>(
...
function startWatch(prop: string | symbol, receiver: SurfaceNode) {
...
export function initializeWatchers(prototype: unknown, receiver: SurfaceNode) {
