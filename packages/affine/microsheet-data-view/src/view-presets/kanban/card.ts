...
const styles = css`
  ...
  affine-microsheet-data-view-kanban-card:hover {
    background-color: var(--affine-hover-color);
  }

  affine-microsheet-data-view-kanban-card .card-header {
    padding: 8px;
    display: flex;
    flex-direction: column;
    gap: 8px;
  ...
  affine-microsheet-data-view-kanban-card .card-header-title {
    font-size: var(--data-view-cell-text-size);
    line-height: var(--data-view-cell-text-line-height);
  }

  affine-microsheet-data-view-kanban-card .card-header-icon {
    padding: 4px;
  ...
  affine-microsheet-data-view-kanban-card .card-header-icon svg {
    width: 16px;
    height: 16px;
  ...
  affine-microsheet-data-view-kanban-card .card-body {
    display: flex;
    flex-direction: column;
    padding: 8px;
    gap: 4px;
  ...
  affine-microsheet-data-view-kanban-card:hover .card-ops {
    visibility: visible;
  }
...
export class KanbanCard extends SignalWatcher(
  ...
  private contextMenu = (e: MouseEvent) => {
    ...
    if (selection) {
      ...
      const ref =
        target.closest('affine-microsheet-data-view-kanban-cell') ?? this;
      popCardMenu(
        this.dataViewEle,
  ...
  private getSelection() {
    return this.closest('affine-microsheet-data-view-kanban')
      ?.selectionController;
  }
    ...
    return html` <div class="card-body">
      ${repeat(
        ...
        column => {
          ...
          return html` <affine-microsheet-data-view-kanban-cell
            .contentOnly="${false}"
...
declare global {
  interface HTMLElementTagNameMap {
    'affine-microsheet-data-view-kanban-card': KanbanCard;
  }
}
