...
const styles = css`
  ...
  affine-microsheet-data-view-kanban-cell:hover {
    background-color: var(--affine-hover-color);
  }

  affine-microsheet-data-view-kanban-cell .icon {
    display: flex;
    align-items: center;
  ...
  affine-microsheet-data-view-kanban-cell .icon svg {
    width: 16px;
    height: 16px;
...
export class KanbanCell extends SignalWatcher(
  ...
  renderIcon() {
    ...
    return html` <microsheet-uni-lit
      class="icon"
...
declare global {
  interface HTMLElementTagNameMap {
    'affine-microsheet-data-view-kanban-cell': KanbanCell;
  }
}
