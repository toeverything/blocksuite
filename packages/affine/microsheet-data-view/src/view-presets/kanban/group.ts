...
const styles = css`
  ...
  affine-microsheet-data-view-kanban-group:hover .group-header-op {
    visibility: visible;
    opacity: 1;
  }
  ...
  affine-microsheet-data-view-kanban-group:hover .add-card {
    visibility: visible;
    opacity: 1;
  }

  affine-microsheet-data-view-kanban-group .add-card:hover {
...
export class KanbanGroup extends SignalWatcher(
  ...
  private clickAddCard = () => {
    ...
    requestAnimationFrame(() => {
      const kanban = this.closest('affine-microsheet-data-view-kanban');
      if (kanban) {
...
declare global {
  interface HTMLElementTagNameMap {
    'affine-microsheet-data-view-kanban-group': KanbanGroup;
  }
}
