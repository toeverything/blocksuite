...
export class DataViewHeaderViews extends WidgetBase {
  static override styles = css`
    ...
    .microsheet-view-button .icon {
      margin-right: 6px;
      display: block;
    }

    .microsheet-view-button .icon svg {
      width: 16px;
      height: 16px;
    }

    .microsheet-view-button.active {
  ...
  renderMore = (count: number) => {
    ...
    if (count === views.length) {
      ...
      return html`<div
        class="microsheet-view-button dv-icon-16 dv-hover"
        data-testid="microsheet-add-view-button"
    ...
    return html`
      <div class="microsheet-view-button dv-hover" @click="${this._showMore}">
