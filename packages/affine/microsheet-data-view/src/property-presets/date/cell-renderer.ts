...
export class DateCell extends BaseCellRenderer<number> {
  static override styles = css`
    affine-microsheet-date-cell {
      width: 100%;
    }

    .affine-microsheet-date {
      display: flex;
      align-items: center;
      width: 100%;
      padding: 0;
    ...
    input.affine-microsheet-date[type='date']::-webkit-calendar-picker-indicator {
      display: none;
    }
  `;
  ...
  override render() {
    ...
    return html` <div class="affine-microsheet-date date">${value}</div>`;
  }
}

export class DateCellEditing extends BaseCellRenderer<number> {
  static override styles = css`
    affine-microsheet-date-cell-editing {
      width: 100%;
      cursor: text;
    }

    .affine-microsheet-date:focus {
      outline: none;
    }
  `;
  ...
  override render() {
    return html` <div
      class="affine-microsheet-date date"
