...
const styles = css`
  ...
  affine-microsheet-progress-cell {
    display: block;
    width: 100%;
    padding: 0 4px;
  }

  .affine-microsheet-progress {
    display: flex;
    align-items: center;
  ...
  .affine-microsheet-progress-bar {
    position: relative;
    width: 104px;
  }

  .affine-microsheet-progress-bg {
    overflow: hidden;
    width: 100%;
    height: 10px;
    border-radius: 22px;
  ...
  .affine-microsheet-progress-fg {
    height: 100%;
  }

  .affine-microsheet-progress-drag-handle {
    position: absolute;
    top: 0;
    left: 0;
...
export class ProgressCell extends BaseCellRenderer<number> {
  ...
  protected override render() {
    ...
    return html` <div class="affine-microsheet-progress">
      <div class="affine-microsheet-progress-bar">
        <div class="affine-microsheet-progress-bg" style=${bgStyles}>
          <div class="affine-microsheet-progress-fg" style=${fgStyles}></div>
        </div>
      </div>
...
export class ProgressCellEditing extends BaseCellRenderer<number> {
    ...
    return html` <div class="affine-microsheet-progress">
      <div class="affine-microsheet-progress-bar">
        <div class="affine-microsheet-progress-bg" style=${bgStyles}>
          <div class="affine-microsheet-progress-fg" style=${fgStyles}></div>
          <div
            class="affine-microsheet-progress-drag-handle"
            style=${handleStyles}
          ></div>
        </div>
      </div>
  ...
  @query('.affine-microsheet-progress-bg')
