...
> {
  static override styles = css`
    affine-microsheet-number-cell {
      display: block;
      width: 100%;
    }

    .affine-microsheet-number {
      display: flex;
      align-items: center;
  ...
  override render() {
    return html` <div class="affine-microsheet-number number">
...
> {
  static override styles = css`
    ...
    .affine-microsheet-number:focus {
      outline: none;
    }
  `;
  ...
  override render() {
    ...
    return html`<input
      ...
      @blur="${this._blur}"
      @focus="${this._focus}"
      class="affine-microsheet-number number"
