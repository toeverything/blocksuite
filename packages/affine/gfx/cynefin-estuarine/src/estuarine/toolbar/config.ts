...
const WaveIcon = (color: string) => html`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2" stroke-linecap="round"><path d="M3 13c3-6 6 4 9 0s6-6 9 0" /></svg>`;
...
export const estuarineToolbarConfig = {
  actions: [
    ...
    booleanToggle('b.toggle-liminal', 'Show / hide the Liminal line', WaveIcon('#2fd11f'), 'showLiminal'),
    booleanToggle('c.toggle-volatile', 'Show / hide the Volatile line', WaveIcon('#ee2a2a'), 'showVolatile'),
    booleanToggle('d.toggle-counterfactual', 'Show / hide the Counter-factual line', WaveIcon('currentColor'), 'showCounterfactual'),
