...
export class ViewStore {
  ...
  fromPath = (path: null | string | undefined): BlockElement | null => {
  ...
  viewFromPath(type: 'block', path: string[]): BlockElement | null;

  viewFromPath(type: 'widget', path: string[]): WidgetElement | null;

  viewFromPath(
    type: 'block' | 'widget',
    path: string[]
  ): BlockElement | WidgetElement | null {
    if (type === 'block') {
