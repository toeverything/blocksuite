...
describe('workspace.search works', () => {
  it('workspace search matching', () => {
    ...
    const page = workspace.createPage({ pageId: 'page0' });
...
describe('backlink works', () => {
  ...
  it('backlink indexer works with subpage', async () => {
    ...
    const page = workspace.createPage({ pageId: 'page0' });
    const subpage = workspace.createPage({ pageId: 'page1' });
  ...
  it('backlink indexer works with linked page', async () => {
    ...
    const page0 = workspace.createPage({ pageId: 'page0' });
    const page1 = workspace.createPage({ pageId: 'page1' });
  ...
  it('backlink indexer can remove subpage node', async () => {
    ...
    const page = workspace.createPage({ pageId: 'page0' });
    const subpage = workspace.createPage({ pageId: 'page1' });
    const subpage2 = workspace.createPage({ pageId: 'page2' });
