...
test.describe('reordering notes', () => {
  ...
  test('bring to front', async ({ page }) => {
    ...
    await assertEdgelessSelectedRect(page, [160, 100, 448, 79]);
    ...
    await assertEdgelessSelectedRect(page, [130, 100, 448, 79]);

    // should be note0
    await page.mouse.click(120, 140);
    await assertEdgelessSelectedRect(page, [100, 100, 448, 79]);
